...
public class DatabaseHelper3 extends SQLiteOpenHelper {
    public static final String DATABASE_NAME = "db34.db";
    public static final String TABLE_NAME = "tbl34";
    ...
    public  static  final String COL_17 = "data";
    public  static  final String COL_18 = "variance";
    ...
    public boolean insertData(String sapNumber, String fromBranch,  String itemName,Double quantity,Double actual_quantity,int isSAPIT,String toBranch,int baseID, String fromModule,int isSelected, String uom,double received_quantity, int item_id, int objtype, int isClosed, String data, double variance){
        ...
        contentValues.put(COL_17, data);
        contentValues.put(COL_18, variance);
    ...
    public Cursor getAllSelected(String fromModule){
        Cursor cursor;
        SQLiteDatabase db = this.getWritableDatabase();
